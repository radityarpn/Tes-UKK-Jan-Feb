      ...
      <div class="col-md-6 offset-md-3">
        ...
        <div class="card my-5">
          ...
          <form class="card-body cardbody-color p-lg-5">
            ...
            <div class="text-center"><button type="submit" class="btn btn-dark px-5 mb-5 w-100"><a href="pengaduan_masyarakat.php">Register</a></button></div>
            <div id="emailHelp" class="form-text text-center mb-5 text-dark">Have account? <a href="login_masyarakat.php"> Register</a>
        </div>
